    ...
    <div class="w-full mb-8">
        <CosmicCard title="Game Description">
            <div class="relative z-10 overflow-hidden">
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-primary/5 to-secondary/10 z-0 opacity-30"></div>
                ...
                <!-- Description Content -->
                <div 
                    class="prose prose-sm md:prose-base lg:prose-lg max-w-none text-gray-200 relative z-10"
...
const sanitizedDescription = computed(() => {
    if (!props.description) return '<p>No description available for this product.</p>';

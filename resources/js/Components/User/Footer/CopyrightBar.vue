...
<template>
    <div class="py-6 bg-dark text-white/60 text-sm relative overflow-hidden">
        ...
        <div class="absolute inset-0 overflow-hidden opacity-5">
            ...
            >
                <line x1="10" y1="2" x2="20" y2="6" stroke="white" stroke-width="0.1" />
                <line x1="20" y1="6" x2="30" y2="3" stroke="white" stroke-width="0.1" />
                <line x1="30" y1="3" x2="40" y2="8" stroke="white" stroke-width="0.1" />
                <line x1="40" y1="8" x2="60" y2="5" stroke="white" stroke-width="0.1" />
                <line x1="60" y1="5" x2="70" y2="9" stroke="white" stroke-width="0.1" />
                <line x1="70" y1="9" x2="90" y2="4" stroke="white" stroke-width="0.1" />
        ...
        <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between">
            <!-- Copyright text with cosmic symbol -->
            <div class="flex items-center mb-4 sm:mb-0">
                <span class="mr-2 text-white">&#x1F7BC;</span> <!-- Unicode symbol for cosmic copyright -->
            ...
            <div class="relative flex items-center">
                ...
                <div class="relative mr-3">
                    ...
                    <!-- Beacon pulse -->
                    <div 
                        class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10 h-10 rounded-full transition-opacity duration-1000"
                        :class="beaconPulse ? 'opacity-40' : 'opacity-0'"
                        style="background: radial-gradient(circle, rgba(155,135,245,0.3) 0%, rgba(155,135,245,0) 70%);"
                    ></div>
                </div>

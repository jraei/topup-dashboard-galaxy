  ...
  <div class="min-h-screen bg-dark text-white flex">
    ...
    >
      <div class="h-full py-6 px-2 flex flex-col bg-dark-sidebar rounded-r-xl shadow-float">
        ...
        <!-- Navigation Links -->
        <div class="flex-1 px-2 space-y-1 overflow-y-auto scrollbar-hide">
          <!-- Dashboard -->
          <Link 
          ...
          <div>
            <button
              ...
              :class="[
                ...
                (route().current('admin.categories') || route().current('admin.products') || route().current('admin.services')) 
                  ? 'bg-primary/20 text-white shadow-glow-primary' 
                  : 'text-gray-300 hover:bg-dark-lighter hover:text-white'
              ]"
            >
          ...
          <div>
            <button
              ...
              :class="[
                'w-full flex items-center justify-between rounded-lg p-3 text-base font-medium transition-all duration-200',
                (route().current('admin.payment-providers') || route().current('admin.payment-methods')) 
                  ? 'bg-primary/20 text-white shadow-glow-primary' 
                  : 'text-gray-300 hover:bg-dark-lighter hover:text-white'
              ]"
            >
            ...
            <Dropdown align="right" width="48">
              ...
              <template #content>
                <div class="bg-dark-card border border-gray-700 rounded-md shadow-lg">
                  ...
                  <div class="py-1">
                    <DropdownLink :href="route('profile.edit')" class="hover:bg-dark-lighter hover:text-white">
                      Profile
                    </DropdownLink>
                    <DropdownLink :href="route('admin.settings')" class="hover:bg-dark-lighter hover:text-white">
                      Settings
                    </DropdownLink>
                  </div>
                  <div class="py-1 border-t border-gray-700">
                    <DropdownLink :href="route('logout')" method="post" as="button" class="w-full text-left hover:bg-dark-lighter hover:text-white">
                      Log Out
                    </DropdownLink>
                  </div>
                </div>

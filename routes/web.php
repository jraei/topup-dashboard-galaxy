...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::get('paket-layanans/{id}/fusion-services', [PaketLayananController::class, 'getFusionServices'])->name('paket-layanans.fusion-services');
    
    // Fusion services routes
    Route::post('fusion-services', [PaketLayananController::class, 'storeFusionService'])->name('fusion-services.store');
    Route::put('fusion-services/{id}', [PaketLayananController::class, 'updateFusionService'])->name('fusion-services.update');
    Route::delete('fusion-services/{id}', [PaketLayananController::class, 'destroyFusionService'])->name('fusion-services.destroy');
});

                ...
                if ($request->resultCode === '00') {
                    ...
                    if ($status == "processing") {
                        ...
                        if ($order->fusion_service_id) {
                            ...
                            $produk = $firstService->produk->nama . ' - ' . $fusionService->nama_fusion;
                        } else {
                            $dataLayanan = $order->layanan;
                            $produkObj = Produk::where('id', $dataLayanan->produk_id)->first();
                            $produk = $produkObj->nama . ' - ' . $dataLayanan->nama_layanan;
                        }

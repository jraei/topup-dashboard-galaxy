    ...
    <section id="contact" className="py-20 lg:py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">hello@nexuswebsite.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">123 Innovation Way,<br />San Francisco, CA 94107</p>
                </div>
              </div>
            </div>
          ...
          <div className="animated-border p-[1px] rounded-xl animate-fade-in" style={{ animationDelay: "0.3s" }}>
